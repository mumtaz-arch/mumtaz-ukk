...
/**
 * Setup Admin Account
 * Buat user baru: mumtaz / mumtaz123
 */

// Konfigurasi database langsung
$host = 'localhost';
$dbname = 'inventaris_mumtaz';
$username = 'root';
$password = '';
...
try {
    ...
    if ($result) {
        ...
        echo "<p>Username: <strong>mumtaz</strong></p>";
        echo "<p>Password: <strong>mumtaz123</strong></p>";
    ...
    $stmt = $pdo->query("SELECT * FROM users WHERE username = 'mumtaz'");
    $user = $stmt->fetch(PDO::FETCH_ASSOC);
    
    if ($user) {
        $verify = password_verify('mumtaz123', $user['password']);
