    ...
    <div class="app-layout">
        ...
        <aside class="app-sidebar">
            <div class="sidebar-brand">
                ...
                <span class="brand-text">Inv<strong>Sis</strong></span>
            </div>
            ...
            <nav class="sidebar-menu">
                ...
                <p class="menu-label" style="margin-top: 16px;">Transaksi</p>
                ...
                <p class="menu-label" style="margin-top: 16px;">Laporan</p>
        ...
        <div class="app-main">
            ...
            <header class="app-topbar">
                ...
                <div class="topbar-right">
                    ...
                    <a href="<?= $base_url ?>/app/auth/logout.php" class="btn-logout-icon" title="Keluar">
